...
class part_time_empoyee(Employee):
    ...
    def calculate_salary(self):
        return self._hourrs_worked * self._rate_per_hour
...
class PayrollApp:
    ...
    def create_employee(self,emp_type):
        if emp_type == "FullTime":
            return full_time_employee(1,"Amit" , 50000)
        else:
            return part_time_employee(2,"Ruban" , 5, 400)
